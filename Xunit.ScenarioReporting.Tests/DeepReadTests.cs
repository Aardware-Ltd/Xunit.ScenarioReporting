...
namespace Xunit.ScenarioReporting.Tests
{
    public class DeepReadTests
    {
        ...
        {
            _reader = new ReflectionReader(new Dictionary<Type, string>(),new Dictionary<Type, Func<object, string>>(), new List<MemberInfo>(), new Dictionary<Type, Func<string, bool, object, ObjectPropertyDefinition>>(), (_, __) => false, _=>false);
        }
        class TestData
        {
